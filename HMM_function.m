function [alfa, beta] = HMM_function(priznaky, means, varis, matice_ppsti_prechodu)
%HMM_FUNCTION Summary of this function goes here
%%
...
prechody_ppst = matice_ppsti_prechodu; 
